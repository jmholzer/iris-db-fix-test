...
# iris_db_fix_test documentation build
...
from iris_db_fix_test import __version__ as release

# -- Project information -----------------------------------------------------

project = "iris_db_fix_test"
author = "Kedro"
...
htmlhelp_basename = "iris_db_fix_testdoc"
...
latex_documents = [
    (
        master_doc,
        "iris_db_fix_test.tex",
        "iris_db_fix_test Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "iris_db_fix_test",
        "Project iris_db_fix_test codebase.",
        "Nearest-Neighbour",
    )
]
